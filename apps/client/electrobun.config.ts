...
export default {
    ...
    mac: {
      ...
      entitlements: {
        "com.apple.security.device.camera":
          "Required for voice and video channel communications.",
        "com.apple.security.device.audio-input":
          "Required for voice channel communications.",
        "com.apple.security.cs.allow-unsigned-executable-memory":
          "Required for WebRTC screen capture.",
      },
    },
    linux: {
      bundleCEF: false,
  ...
  release: {
    ...
    baseUrl:
      "https://github.com/SashaGoncharov19/sevencord/releases/latest/download",
  },
  scripts: {
